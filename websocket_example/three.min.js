...
b.uniform3f(F.color,I.color.r,I.color.g,I.color.b);c.setBlending(I.blending,I.blendEquation,I.blendSrc,I.blendDst);c.setTexture(I.texture,1);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0)}}}}b.disable(b.CULL_FACE);b.enable(b.DEPTH_TEST);b.depthMask(true)}}};
...
b.uniform1f(s.opacity,x.opacity);b.uniform3f(s.color,x.color.r,x.color.g,x.color.b);b.uniform1f(s.rotation,x.rotation);b.uniform2fv(s.scale,A);if(x.mergeWith3D&&!z){b.enable(b.DEPTH_TEST);z=true}else if(!x.mergeWith3D&&z){b.disable(b.DEPTH_TEST);z=false}c.setBlending(x.blending,x.blendEquation,x.blendSrc,x.blendDst);c.setTexture(x.map,0);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0)}}b.disable(b.CULL_FACE);b.enable(b.DEPTH_TEST);b.depthMask(true)}}};
